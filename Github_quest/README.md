아이언맨에서 나왔던 AI비서 '자비스' 현실에서도 볼 수 있나?
==
마크 저커버그가 직접 만든 AI비서 '자비스'에 대해 알아보자
--
...
자비스는 어떻게 개발됐는지, 무엇을 할 수 있는지, 그리고 AI에 대해 **저커버그**는 어떤 생각을 하고 있는지 살펴 보세요. 원문은 해당 링크(https://www.facebook.com/notes/mark-zuckerberg/building-jarvis/10154361492931634)에서 확인하실 수 있습니다.
...
AI가 사람을 대체할 수 있는 시기가 다가온다
==
GPT-4 발표한 오픈AI'샘 알트만', AI가 일자리를 대체할 가능성이 있으며 얼마나 빨리 일어날 수 있는지 걱정
--
...
4차 산업혁명의 뜨거운 감자 인공지능의 전망
==
세계 4대 ai 석학 앤드류 응 교수, "인공지능은 더 많은 가치를 창출하고 있고, 경제적인 시너지를 발휘하고 있다. 이는 AI 업계에  한 때의 유행이 아닌 영원한 봄이다."
--
...
리눅스는 완전 생 초짜다 보니 명령어나 사용법에 많이 애먹었다....
Git도 마찬가지로 shell 이 아닌 인텔리제이로 활용하다 보니 어색하고 헤매는 부분이 많았다.
리눅스와 shell 에 대해 더 많은 반복과 복습을 해봐야할거 같다.


[뉴스 기사에 대한 회고]

AI의 발전으로 생기는 이점이 많지만 위험성도 상당하다는게 양날의 검이라 생각든다.
마크버그가 만든 '자비스'는 AI비서로 집에서 생활하는 데에 도움을 줄 수 있게 만들어졌는데 만일 '자비스'가 해킹 당한다면 집안에 외부인이 침입하기 수월해질 것이라 생각합니다.
그 외에도 AI를 사용한 상담사가 생기면서 상담을 진행하는데 폭언이나 욕설 등 인격모독을 당하지는 않지만 사람들의 일자리가 사라진다.
이러한 점을 생각하고 고민해보며 AI를 개발해야하는 게 아닐까?
